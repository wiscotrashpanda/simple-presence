...
- **Terraform**: Use HCL formatting, 2-space indentation, organize resources by service (S3, CloudFront, etc.)
...
- For infrastructure: validate Terraform with `terraform validate` and `terraform plan` before applying
